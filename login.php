...
.social-login__icon:hover {
	...
	<div class="screen">
		<div class="screen__content">
			<form class="login" role="form" action="includes/login_inc.php" method="post" id="login-form" autocomplete="off">
				...
				<div class="login__field">
					...
					<input type="password" name="password" id="key" class="login__input" placeholder="Password">
				</div>
